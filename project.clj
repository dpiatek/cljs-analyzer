(defproject cljs-analyzer "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "cljs-analyzer.example/on-js-reload"
                ...
                :compiler {:main cljs-analyzer.example
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/cljs_analyzer.js"
                           :main cljs-analyzer.core
